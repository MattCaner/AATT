...
def train_until_difference_cuda(model: nn.Module, train_dataset: CustomDataSet, device: int = 0, batch_size = 32, min_difference = 0.001, lr: float = 0.1, max_epochs: int = 50, criterion = torch.nn.CrossEntropyLoss()) -> float:
