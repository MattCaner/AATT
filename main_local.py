...
def run_global_sasa():
    strategy = AnnealingStrategyGlobalSasa(num_threads=8,t_train=3,max_iters=50,best_update_interval=10,alpha=0.9,test_mode=False,configFile=configpath,csv_output=outpath+"/sasa_out.csv")
    strategy.run()
