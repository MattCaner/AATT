...
bleu = strategy.performBleuMetrics(useparams = False,filename_in = "simplepl.txt", filename_out="simplepl.txt")
rogue = strategy.performRogueMetrics(useparams = False,filename_in = "simplepl.txt", filename_out="simplepl.txt")
print(bleu)
pprint(rogue)